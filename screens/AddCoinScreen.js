...
import { TextInput, Text, Button, PaperProvider, Menu } from "react-native-paper";
  ...
  return (
    <SafeAreaView style={styles.container}>
      <PaperProvider style={styles.container}>
        <Text style={styles.contentCenter} variant="headlineMedium">Add a New Coin</Text>
        ...
        <View style={[styles.row, styles.contentCenter, {marginVertical: 5}]}>
          <Button onPress={() => {
...
const styles = StyleSheet.create({
  ...
  picker: { //should be the same as react-native-paper textinput styling
    width: 250,
    height: 56,
    margin: 0,
    flexGrow: 1,
  ...
  pickerContainer: { //should be the same as react-native-paper textinput styling
